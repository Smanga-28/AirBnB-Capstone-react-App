...
import Login from '../Login/Login'; // Assuming the Login component is in the same folder
...
const Homepage = () => {
  ...
  return (
    <div>
      {showLogin ? (
        // Conditionally render Login component if the user clicks "Become a Host"
        <Login />
      ) : (
        // Render the homepage content if "Become a Host" isn't clicked yet
        <HomePage>
          <HeaderContainer>
            <Logo>
            ...
            <ProfileSection>
              {/* Add onClick handler to trigger login page */}
              <BecomeHost href="#" onClick={handleBecomeHostClick}>
                Become a Host
              </BecomeHost>
              <GlobeIcon>🌐</GlobeIcon>
              <ProfileIcon>
